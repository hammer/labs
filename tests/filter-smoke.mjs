...
// ── Home: clean load ─────────────────────────────────────────────────
{
  ...
  log('home: clean load', t.rows === 60 && t.visible === 60 && t.hasFilterBar && t.paletteHidden, JSON.stringify(t));
  await page.close();
}
...
// ── Home: Clear all ──────────────────────────────────────────────────
{
  ...
  log('home: Clear all', t.chips === 0 && t.visible === 60 && t.url === '', JSON.stringify(t));
  await page.close();
}
